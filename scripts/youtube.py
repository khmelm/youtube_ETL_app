...
test_dict = {'Power BI': ['77jIzgvCIYY', 'MrLnibFTtbA'], 'Power Query': ['NalazxBo-90', 'MrLnibFTtbA'], 'Data Analysis with Power BI': ['8tfcVnoEL0c', '77jIzgvCIYY'], 'DAX Formula in Power BI': ['QJw4HkagVWc', '77jIzgvCIYY'], 'Power Query Tutorial': ['NalazxBo-90', '77jIzgvCIYY'], 'Power BI Desktop Tutorial': ['77jIzgvCIYY', '5X5LWcLtkzg'], 'M Language in Power Query': ['yx7rg3NA4BQ', '_ZKT1raC4P0'], 'Power Query Functions': ['Qf_i45WinRo', 'uUbKZrT14AY'], 'Power BI Data Modeling': ['MrLnibFTtbA', 'KJZ7doWuQ7w'], 'Power BI Visualization Techniques': ['5TS2s6gXO1k', 'rufDif4cWq8'], 'Power BI Tips and Tricks': ['tQseyYfZpVk', 'xoR-2NjZCCk'], 'Data Transformation with Power Query': ['NiefTeo6bJk', 'NalazxBo-90']}
